...
export default function Modal({
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center text-neutral-dark font-semibold font-primary">
      <div className="grid gap-12 bg-white p-12 w-full max-w-lg relative rounded-xl">
        <header>
        ...
        <footer className="absolute top-12 right-12">
          <button
